...
def wave(attack_t, decay_t, sustain_level, release_t, wave_type, filter_type, filter_ratio, f1, Fs = 8000):
    global ISPRESS
    global CONTINUE
...
wave(attack_t = 0.05, decay_t = 0.2, sustain_level = 0.5, release_t = 0.3, f1 = 440, wave_type = 'square', filter_type = None, filter_ratio = 1.5)
